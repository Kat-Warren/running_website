...
from app.models import Races
from datetime import datetime

# Initialize Flask app
app = create_app()  # Make sure this matches your app initialization function in app/__init__.py
...
with app.app_context():
    ...
    print("Races table populated successfully!")
